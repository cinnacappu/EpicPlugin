...
public class EpicPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        System.out.println("§2§l[EP]§r§b v3.5 loading...");
        ...
        System.out.println("§2§l[EP]§r§b v3.5 loaded!");
        System.out.println("§6******************************");
    ...
    public void onDisable() {
        System.out.println("§6******************************");
        System.out.println("§2§l[EP]§r§b v3.5 disabled!");
        System.out.println("§6******************************");
    }
}